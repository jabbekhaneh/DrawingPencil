      ...
      <ul class="space-y-2">
        ...
        <li>
          <button
            ...
            dropdown-control="dropdown-example"
            v-on:click="ShowMenu($event)"
          >
            <i class="material-icons flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white">dashboard</i>
            <span
...
export default {
    ...
    methods:{
        ...
        ShowMenu:function(event){
            ...
            var dropdownControl= dropdownElement.getAttribute('dropdown-control');
            var subMenu =document.querySelector('#' + dropdownControl);
